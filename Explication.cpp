...
GameState* Explication::getNextState(){
    if(!expl){
        ...
        else if(name == "bagarre") return new Bagarre(window, save, save.getInventory(), "texture/texture_decor/2Qpng.png","texture/texture_char/new_player2.png", 8, 20, 800, 400, 0, false);
